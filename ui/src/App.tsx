...
import CrosshairSection from './components/crosshair/CrosshairSection';
...
export default function App() {
  ...
  const handleApplySliders = () => fetchNui('setSliders', { lodDistance, lightsCutoff, shadowsCutoff });
  ...
  return (
    <div className="flex h-screen w-full p-4 relative font-sans text-white">
      ...
      <MriCard className="absolute right-8 top-1/2 -translate-y-1/2 w-[420px] max-h-[90vh] z-10 bg-[#141414] border border-[#222222] shadow-2xl rounded-2xl overflow-hidden flex flex-col">

        <MriCardHeader className="bg-[#1C1C1C] p-6 border-b border-[#222222] flex flex-row justify-between items-start pb-5 flex-shrink-0">
        ...
        <MriCardContent className="p-6 overflow-y-auto flex-1">
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`h-[68px] flex flex-col items-center justify-center rounded-xl transition-all ${activePreset === 'default' ? 'bg-[#00E576] text-black font-bold' : 'bg-[#121212] border border-[#222222] text-white hover:border-[#444444]'}`}
              >
              ...
              <button
                ...
                className={`h-[68px] flex flex-col items-center justify-center rounded-xl transition-all ${activePreset === 'medium' ? 'bg-[#00E576] text-black font-bold' : 'bg-[#0A0A0A] border border-[#222222] text-white hover:border-[#444444]'}`}
              >
              ...
              <button
                ...
                className={`h-[68px] flex flex-col items-center justify-center rounded-xl transition-all ${activePreset === 'low' ? 'bg-[#00E576] text-black font-bold' : 'bg-[#0A0A0A] border border-[#222222] text-white hover:border-[#444444]'}`}
              >
              ...
              <button
                ...
                className={`h-[68px] flex flex-col items-center justify-center rounded-xl transition-all ${activePreset === 'ulow' ? 'bg-[#00E576] text-black border-transparent font-bold' : 'bg-[#0A0A0A] border border-[#00E576]/30 text-[#00E576] hover:bg-[#00E576]/10'}`}
              >
          ...
          <div className="h-[1px] w-full bg-[#222222] mb-8" />
          ...
          <div className="space-y-6 mb-8">
            <div className="flex justify-between items-center pl-1 mb-2">
              ...
              <button onClick={handleResetSliders} className="text-xs text-neutral-400 hover:text-white transition-colors">Resetar</button>
            </div>
            ...
            <div className="space-y-3">
              ...
              <input type="range" min="0.1" max="10" step="0.1" value={lodDistance}
            ...
            <div className="space-y-3">
              ...
              <input type="range" min="0" max="10" step="0.1" value={lightsCutoff}
            ...
            <div className="space-y-3">
              ...
              <input type="range" min="0" max="5" step="0.1" value={shadowsCutoff}
          ...
          <button
            ...
            className="w-full h-14 bg-[#00E576] hover:bg-[#00E576]/90 text-black font-bold text-sm tracking-widest rounded-xl transition-all mb-8"
          >
            APLICAR AJUSTES
          </button>
